...
RUN apt-get update && apt-get install -y llvm-14-tools coreutils util-linux yq grep procps bash sudo git python3.12-venv wget build-essential libssl-dev zstd && apt-get clean
